...
- Adds Picture-in-Picture (PiP) support with `startPictureInPicture`,
  `stopPictureInPicture`, `isPictureInPictureSupported`,
  `setAutoPictureInPicture`, and `setPictureInPictureActions` methods.
