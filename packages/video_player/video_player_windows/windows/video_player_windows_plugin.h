...
class VideoPlayerWindowsPlugin : public flutter::Plugin,
 ...
 public:
  ...
  explicit VideoPlayerWindowsPlugin(flutter::PluginRegistrarWindows* registrar);
  ...
  void Create(const CreationOptions& options,
 ...
 private:
  ...
  void SendVideoEvent(int64_t player_id, const flutter::EncodableMap& event);
